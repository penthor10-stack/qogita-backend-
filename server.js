...
var cats=[“hair-care”,“skin-care”,“shampoo”,“conditioner”,“hair-colour”,“body-care”,“fragrance”];
var all=[];
...
return{gtin:p.gtin||””,name:(p.name||””).substring(0,80),brand:p.brandName||p.brand||””,category:cats[i],price:parseFloat(p.minPrice||p.price||0),inventory:parseInt(p.inventory||0)};
...
app.listen(process.env.PORT||3001,function(){console.log(“Running”);});
