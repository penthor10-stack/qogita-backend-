...
var url = QOGITA + “/variants/search/?page=” + page + “&page_size=100”;
...
price: parseFloat(p.unit_price || p.price || p.lowestPrice || 0),
inventory: parseInt(p.available_quantity || p.inventory || 0)
};
